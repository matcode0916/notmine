...
import { Loader2, KeyRound, AtSign, LogIn } from 'lucide-react';
  ...
  const handleLogin = async (e) => {
    ...
    if (!supabase) {
      toast({
        ...
        description: "Por favor, conecta tu proyecto de Supabase para activar el inicio de sesión. Las instrucciones están en el chat.",
        variant: "destructive",
        duration: 8000
      });
      setLoading(false);
      ...
      >
        <Card className="w-full max-w-md mx-auto modern-card">
          <CardHeader className="text-center">
            ...
            <CardTitle className="orbitron-font text-3xl">Iniciar Sesión</CardTitle>
            <CardDescription>Accede a tu cuenta de notmine.com</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="password" type="password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} required className="pl-10 modern-input" />
                </div>
              </div>
